-- Migration: Regrade all past submissions to align with the new scoring rules
DO $$
DECLARE
    sub_rec RECORD;
    ans_rec RECORD;
    ...
    -- variables for scoring (prefixed with v_ to avoid ambiguity)
    v_correct_count INT;
    v_wrong_count INT;
